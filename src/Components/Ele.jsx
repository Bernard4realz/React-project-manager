...
const Ele = forwardRef(function Ele({onActive}, ref) {
    return (
      ...
      <div className="flex justify-center pt-16 bg-[#776B5D] h-screen">
        <div className=" flex justify-center w-[36rem] h-[35rem] bg-stone-200 border-2 rounded-md">
          <div>
            ...
            <button className="px-4 py-2 text-xs rounded-md md:text-base bg-[#B0A695] text-stone-100 hover:bg-black " onClick={onActive}>Let's get active!</button>
            <footer className="mt-24">Powered by Bernard4realz</footer>
          </div>
        </div>
